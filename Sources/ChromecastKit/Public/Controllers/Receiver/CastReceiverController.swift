...
public actor CastReceiverController {
    ...
    public func getAppAvailability(appIDs: [CastAppID]) async throws -> CastRequestID {
        try await sendPlatformCommand(CastReceiverPayloadBuilder.getAppAvailability(appIDs: appIDs))
    }
